...
const Testimonials: FC = () => {
  ...
  return <section className="section">
      <h2 className=" flex flex-col overflow-hidden whitespace-nowrap text-4xl md:text-7xl lg:text-8xl">
        <span>Some nice words from my past clients</span>
        <span className="self-end text-red-orange-500">Some nice words from my past clients</span>
      </h2>
    <div className="container">
      <div className="mt-20 md:mt-16 lg:mt-20">
        {testimonials.map(({ name, company, role, quote, image, imagePositionY } , index ) => index === testimonialIndex && (
          <div key={name} className="grid md:grid-cols-5 md:gap-8  md:items-center lg:gap-16">
      ...
      <div className="flex gap-4 mt-6 lg:mt-10">
        <button className="border rounded-full size-11 inline-flex items-center justify-center border-stone-400">
