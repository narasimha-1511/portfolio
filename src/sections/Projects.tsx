      ...
      <div className="mt-10 md:mt-16 lg:mt-20">
        {projects.map(({ name , image }) => (
          <a key={name} href="#" className="border-t last:border-b py-6 md:py-8 lg:py-10 border-stone-400 border-dotted flex flex-col relative group/project">
            <div className="absolute top-0 left-0 w-full h-0 group-hover/project:h-full transition-all duration-700 bg-stone-300"></div>
            <div className="relative">
              <div className="aspect-video md:hidden">
                <Image src={image} alt={name} className="w-full"/>
              </div>
              <div className="flex mt-8 md:mt-0 justify-between items-center md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8 ">
